...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p accead3c-30f0-408d-a2ab-faae75c9508c
```

> `accead3c-30f0-408d-a2ab-faae75c9508c` is the password of the certificate, you can change it to any password you want.
